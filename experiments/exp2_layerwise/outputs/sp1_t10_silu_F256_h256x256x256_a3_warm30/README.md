# Run `sp1_t10_silu_F256_h256x256x256_a3_warm30`
...
|---|---|---|---|
| unseen spatial (no timestep seen) | 1.2376812823868795 | 2.682377835448629 | 10 |
| seen points (held-out timesteps) | 0.13680092959588053 | 0.818161242716522 | 40 |
