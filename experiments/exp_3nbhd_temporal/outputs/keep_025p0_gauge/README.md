...
|---|---|
| seen (temporal infill at training points) | 0.254 |
| neighborhood (spatial holdout, 15 unseen pts) | 1.049 |
| far (extrapolation, away from all clusters) | 2.273 |

Per-neighborhood (seen / neighborhood spatial): near_source 0.101 / 1.043, in_between 0.254 / 0.828, near_boundary 1.095 / 1.110
